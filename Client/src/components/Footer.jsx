  ...
  return (
    <footer className="footer footer-center p-10 bg-primary text-primary-content">
      ...
      <div>
        ...
        <img src = {lglogo} width = "50" height = "50" viewBox = "0 0 24 24" className="inline-block fill-current"></img>
        
        <p className="font-bold">

          Luke Graham <br/>Placeholder Text
        </p> 

        <p>Copyright © 2023 - Placeholder Text</p>
